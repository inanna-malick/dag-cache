...
fn main() -> Result<(), std::io::Error> {
    ...
    let ipfs_node = IPFSNode::new(http::uri::Authority::from_static("localhost:5001"));
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .route("/object/get/{n}", web::get().to_async(api::get::<Capabilities>))
            .route("/object/put", web::post().to_async(api::put::<Capabilities>))
            .route("/objects/put", web::post().to_async(api::put_many::<Capabilities>))
    })
    .bind("127.0.0.1:8088")
